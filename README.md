...
Moderator Python bot for discord!

Add it to your server with this link: https://discord.com/api/oauth2/authorize?client_id=902696335961120789&permissions=8&scope=bot

### Description

This modaration focused bot reads the last messages of a user and detects whether it is going towards to bad behavior like discrimation, racism, homofobia, bullying etc; using a generative AI model.

This way, users will receive feedback when someone is presenting those attitudes helping the whole group to understand what is happening and validating feelings that could not have been clear to the target person or group.
